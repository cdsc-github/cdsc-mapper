#!/bin/sh
##
## compile_cpp_cpu.sh: This file is part of the CDSCmp project.
##
...
shift 1;
CXXFLAGS="";
CFLAGS="-O3 -I. -I$CNCC_HOME/include -I$HC_HOME/include/hc -fopenmp";
